...
package resource_logforwardersource
...
func LogforwardersourceResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				...
				MarkdownDescription: "ID of the log forwarder source to fetch",
			},
...
type LogforwardersourceModel struct {
